...
def load_clip_model(model_path: str, use_fp16: bool = False):
...
class Index_Builder:
    ...
    def __init__(
        ...
        self.image_embedding_save_path = os.path.join(self.save_dir, f"emb_img_{self.retrieval_method}.memmap")
        self.text_embedding_save_path = os.path.join(self.save_dir, f"emb_text_{self.retrieval_method}.memmap")
    ...
    def _save_embedding(self, all_embeddings, save_path=None):
        memmap = np.memmap(
            save_path,
